...
$plink=$_POST['packagelocationlink'];	
$pimage=$_FILES["packageimage"]["name"];
move_uploaded_file($_FILES["packageimage"]["tmp_name"],"pacakgeimages/".$_FILES["packageimage"]["name"]);
$sql="INSERT INTO tbltourpackages(PackageName,PackageType,PackageLocation,PackagePrice,PackageFetures,PackageDetails,PackageLocationLink,PackageImage) VALUES(:pname,:ptype,:plocation,:pprice,:pfeatures,:pdetails,:plink,:pimage)";
...
$query->bindParam(':plink',$plink,PDO::PARAM_STR);
...
<div class="form-group">
<label for="focusedinput" class="col-sm-2 control-label">Street View(360<sup>o</sup> )</label>
									<div class="col-sm-8">
									<input type="text" class="form-control1" name="packagelocationlink" id="packagelocationlink" placeholder="add link of 360 view" required> 
									</div>
								</div>															
<div class="form-group">
